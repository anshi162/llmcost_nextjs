...
export const DEFAULT_PREMIUM = MODELS.find((m) => m.name === "Claude Sonnet 5")!;
export const DEFAULT_CHEAP = MODELS.find((m) => m.name === "Groq Llama 3.1 8B")!;
...
export function monthlyCost(
  ...
  return monthlyCostFromTotals(model, queries * inputTokensPerQuery, queries * outputTokensPerQuery);
}
